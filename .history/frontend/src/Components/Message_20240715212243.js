    ...
    <div className="flex w-full">
      <div className="w-[30rem] flex justify-start">
        ...
        <div className="flex ml-2 justify-start items-center bg-stone-400 rounded-md p-2">
          <div>
            Message dfklasjdflks dfasdj lksadjfl ksdfklasj dflkasj dfjasdlkf jds
            fsd fsdfs dfsdf sdf sdfsd fsdfsd sdjkfhask dfha sdfkjsadhf
            kjasdhfjkasd fkjsadhfkjsadfhk asjdfhkjasd fhkjas hfdkjashdfkja sdkj
          </div>
        </div>
      </div>
    </div>
